...
optional notification delivery is bounded and independent of transcript persistence.
The provider-agnostic backend invokes the locally installed Apprise library
...
layer colors Doctor reports and human-readable project listings while preserving
plain redirected and JSON output.
